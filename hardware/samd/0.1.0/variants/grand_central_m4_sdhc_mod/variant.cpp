...
const PinDescription g_APinDescription[]=
{
  ...
  // Digital High
  { PORTB, 18, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 },
  ...
  { PORTB, 20, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },  // SDA
  { PORTB, 21, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },  // SCL
  ...
  { PORTB, 19, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 }, // XCLK
  ...
  { PORTA, 20, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },
  ...
  // 62..63 - I2C pins (SDA/SCL) <---- THESE ARE NO LONGER I2C PINS IN THIS BOARD VARIANT!!!!
  // ----------------------
  { PORTB, 20, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },  // SDA
  { PORTB, 21, PIO_SDHC, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },  // SCL
