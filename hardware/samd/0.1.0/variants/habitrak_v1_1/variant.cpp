...
//{ _EPortType, [Port Number], _EPioType, [Pin Attributes], _EAnalogChannel, _ETCChannel, _ETCChannel, EExt_Interrupts }
  ...
  { PORTB, 17, PIO_DIGITAL,    PIN_ATTR_PWM_G,      No_ADC_Channel, TCC0_CH5,   TCC0_CH5,     EXTERNAL_INT_1   }, //LED_R           (28) PWM TCC0 WO/5
  { PORTD, 10, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC0_CH3,   TCC0_CH3,     EXTERNAL_INT_5   }, //LED_G           (29) PWM TCC0 WO/3
  { PORTB, 13, PIO_DIGITAL,    PIN_ATTR_PWM_G,      No_ADC_Channel, TCC0_CH1,   TCC0_CH1,     EXTERNAL_INT_13  }, //LED_B           (30) PWM TCC0 WO/1
  ...
  { PORTA, 1,  PIO_DIGITAL,    PIN_ATTR_PWM_E,      No_ADC_Channel, TC2_CH1,    NOT_ON_TIMER, EXTERNAL_INT_2   }, //U_BTN_LED       (40) PWM TC2 WO/1
  { PORTC, 23, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC0_CH7,   NOT_ON_TIMER, EXTERNAL_INT_7   }, //D_BTN_LED       (41) PWM TCC0 WO/7
  { PORTB, 2,  PIO_DIGITAL,    PIN_ATTR_PWM_E,      No_ADC_Channel, TC6_CH0,    NOT_ON_TIMER, EXTERNAL_INT_1   }, //LED_IR          (42) PWM TC6 WO/0
  ...
  { PORTA, 12, PIO_DIGITAL,    PIN_ATTR_PWM_E,      No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_12  }, //CAM_VSYNC       (71) PCC DEN1
  { PORTA, 13, PIO_DIGITAL,    PIN_ATTR_PWM_E,      No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_13  }, //CAM_HSYNC       (72) PCC DEN1
