...
#define R_BOTTOM_VIN                  1130.0f   // Input voltage monitor bottom resistor value, in ohms.
 ...
 * USB
 */
// #define PIN_USB_HOST_ENABLE   (9ul) // PA31 << Fixed samd21_host.c so this doesn't have to be defined.
