...
//{ _EPortType, [Port Number], _EPioType, [Pin Attributes], _EAnalogChannel, _ETCChannel, _ETCChannel, EExt_Interrupts }
  ...
  { PORTA, 1,  PIO_PWM,     PIN_ATTR_PWM,     No_ADC_Channel, PWM2_CH1,   TCC2_CH1,     EXTERNAL_INT_1    }, //LED_R        (8)
  { PORTA, 31, PIO_PWM,     PIN_ATTR_PWM,     No_ADC_Channel, PWM1_CH1,   NOT_ON_TIMER, EXTERNAL_INT_11   }, //LED_G/SWDIO  (9)
  { PORTA, 30, PIO_PWM,     PIN_ATTR_PWM,     No_ADC_Channel, PWM1_CH0,   NOT_ON_TIMER, EXTERNAL_INT_10   }, //LED_B/SWCLK  (10)

  // Speaker
  { PORTA, 8,  PIO_PWM,     PIN_ATTR_PWM,     No_ADC_Channel, PWM5_CH1,   NOT_ON_TIMER, EXTERNAL_INT_NMI  }, //SPKR         (11)
  ...
  // USB
  { PORTA, 28, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8    }, //USB_DETECT   (22) >> USB Host Enable
