...
#define PIN_SERIAL6_TX      (24ul)        //PC04
#define PIN_SERIAL6_RX      (23ul)        //PC05
...
#define PIN_SERIALHCI_RX (1ul)           //PB22, TX/MOSI, S7.2/SA1.2
#define PAD_SERIALHCI_TX (UART_TX_PAD_0)    
#define PAD_SERIALHCI_RX (SERCOM_RX_PAD_2)
#define PIN_SERIALHCI_RTS (19u)          //PA06 - RTS/CS,  SA0.2
#define PIN_SERIALHCI_CTS (2u)           //PC28 - CTS/SCK, S1.1
