...
//{ _EPortType, [Port Number], _EPioType, [Pin Attributes], _EAnalogChannel, _ETCChannel, _ETCChannel, EExt_Interrupts }
  ...
  // { PORTB, 28, PIO_SERCOM,     PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //SPI_SCK         (2)  SERCOM / SPI
  ...
  // { PORTC, 3,  PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3    }, //NINA_ACK        (7)  EXTINT/3
  ...
  // { PORTA, 15, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC2_CH1,   NOT_ON_TIMER, EXTERNAL_INT_NONE }, //TFT_LED         (22) PWM TCC2 WO/1
  // { PORTA, 15, PIO_DIGITAL,    PIN_ATTR_PWM_G,      No_ADC_Channel, TCC1_CH3,   NOT_ON_TIMER, EXTERNAL_INT_NONE }, //TFT_LED         (22) PWM TCC1 WO/3
  ...
  // { PORTB, 17, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC3_CH1,    NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_R          (26) PWM TCC3 WO/1
  // { PORTB, 17, PIO_DIGITAL,    PIN_ATTR_PWM_G,      No_ADC_Channel, TCC0_CH5,    NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_R          (26) PWM TCC0 WO/5
  { PORTD, 10, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC0_CH3,   NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_G           (27) PWM TCC0 WO/3
  // { PORTB, 13, PIO_DIGITAL,    PIN_ATTR_PWM_E,      No_ADC_Channel, TC4_CH1,    NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_G           (27) PWM TC4 WO/1
  // { PORTB, 13, PIO_DIGITAL,    PIN_ATTR_PWM_F,      No_ADC_Channel, TCC3_CH1,   NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_G           (27) PWM TCC3 WO/1
  // { PORTB, 13, PIO_DIGITAL,    PIN_ATTR_PWM_G,      No_ADC_Channel, TCC0_CH1,   NOT_ON_TIMER, EXTERNAL_INT_NONE }, //LED_G           (27) PWM TCC0 WO/1
  ...
  // { PORTB, 16, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0    }, //nRTC_INT        (29) EXTINT/11
  { PORTD, 21, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11   }, //nRTC_INT        (29) EXTINT/11
  { PORTD, 20, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //RTC_EVI         (30) DIGITAL OUT
  ...
  { PORTB, 7,  PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7    }, //VLX_GPIO        (40) EXTINT/9
  // { PORTB, 8,  PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8    }, //VLX_GPIO        (40) EXTINT/9
  ...
  // { PORTC, 25, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9   }, //nMAX_INT        (42) EXTINT/10
  ...
  // { PORTC, 5,  PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5    }, //nRGB_INT        (44) EXTINT/4
  ...
  { PORTC, 21, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5    }, //BQ_GPO          (46) DIGITAL IN
  // { PORTC, 22, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6    }, //BQ_GPO          (46) DIGITAL IN

  // Power Monitoring 
  { PORTB, 6,  PIO_ANALOG,     PIN_ATTR_ANALOG_ALT, ADC_Channel8,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //BAT_NTC         (47) ADC1 AIN/8
  // { PORTD, 0,  PIO_ANALOG,     PIN_ATTR_ANALOG_ALT, ADC_Channel14,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //BAT_NTC         (47) ADC1 AIN/14
  ...
  // { PORTB, 24, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8    }, //LSM_INT1        (49) EXTINT/6
  { PORTB, 23, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7    }, //LSM_INT2        (50) EXTINT/7
  // { PORTB, 25, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9    }, //LSM_INT2        (50) EXTINT/7
  ...
  // OV7725 Camera
  // { PORTC, 11, PIO_DIGITAL,    PIN_ATTR_TIMER,      No_ADC_Channel, NOT_ON_PWM, TCC0_CH1,     EXTERNAL_INT_NONE }, //CAM_XCLK        (54) TIMER TCC0 WO/1
  { PORTC, 11, PIO_DIGITAL,    PIN_ATTR_TIMER_ALT,  No_ADC_Channel, NOT_ON_PWM, TCC1_CH5,     EXTERNAL_INT_NONE }, //CAM_XCLK        (54) TIMER TCC1 WO/5
  // { PORTD, 11, PIO_DIGITAL,    PIN_ATTR_TIMER,      No_ADC_Channel, NOT_ON_PWM, TCC0_CH4,     EXTERNAL_INT_NONE }, //CAM_XCLK        (54) TIMER TCC0 WO/4
  ...
  // Board ID
  // { PORTA, 6,  PIO_ANALOG,     PIN_ATTR_ANALOG,     ADC_Channel6,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, //BOARD_ID        (70) ADC0 AIN/6
  ...
  // { PORTB, 20, PIO_DIGITAL,    PIN_ATTR_DIGITAL,    No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4    }, //USB_DETECT      (71) EXTINT/4
