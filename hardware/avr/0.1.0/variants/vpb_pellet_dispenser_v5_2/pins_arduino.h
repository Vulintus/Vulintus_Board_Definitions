...
#define CIRCUIT_BOARD_VER             	52	// Divide by 10 to match the Eagle design version.

// Stepper driver parameters.
#define STEPPER_DRIVER_MODEL_A4988       	// Stepper driver model.

// OmniTrak library definitions.
#define OMNITRAK_NUM_CUE_LED			0	// Number of cue LEDs.

// Pin definitions. //
#define PIN_SLOT_A          A2
#define PIN_SLOT_D          2
...
#define PIN_DRV_EN          5
#define PIN_DRV_DIR         4
#define PIN_DRV_STEP        7
#define PIN_DRV_RST		 	9
#define PIN_DRV_SLP       	10

#define PIN_SPEED     		A1            // Speed adjustment input (DEPRECATED).

#define PIN_VPB_TRG    		3             

#define PIN_VPB_TRG_A    	A3            // Analog backup for VPB TRG (DEPRECATED).
